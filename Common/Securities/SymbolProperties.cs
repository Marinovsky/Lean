...
namespace QuantConnect.Securities
{
    ...
    public class SymbolProperties
    {
        ...
        /// <summary>
        /// The Minimum order size for certain symbol
        /// </summary>
        ...
        /// </summary>
        public SymbolProperties(string description, string quoteCurrency, decimal contractMultiplier, decimal minimumPriceVariation, decimal lotSize, string marketTicker, decimal minimumOrderSize = 1)
        {
