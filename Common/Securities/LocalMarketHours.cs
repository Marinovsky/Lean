...
namespace QuantConnect.Securities
{
    ...
    public class LocalMarketHours
    {
        ...
        private bool IsContinuousMarketOpen(TimeSpan? lastSegmentEnd, TimeSpan? segmentStart)
        {
            ...
            {
                // If the difference equals segmentStart's total seconds it means lastSegment and segment
                // are consecutives TimeSpans in the same day
                // If the difference equals lastSegment's total seconds it means lastSegment and
